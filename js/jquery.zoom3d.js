...
;(function ($, window, document, undefined) {
    ...
    function Plugin(element, options) {
        ...
        this.content = this.options.content ? 
                       $element.find(this.options.content)[0] : 
    ...
    Plugin.prototype.touchStart = function (event) {
        ...
        if (this.touchEnabled && touches.length === 2) {
    ...
    Plugin.prototype.touchMove = function (event) {
        ...
        if (this.touchEnabled && event.originalEvent.touches.length > 1) { 
            return false;
        }
    ...
    Plugin.prototype.gestureStart = function (event) {
        ...
        $(this.content).on(this.events.GESTURE_CHANGE, function (event) {
